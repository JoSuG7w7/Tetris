...
import tetrisahorasi.Shape.Tetrominoe;
...
public class Board extends JPanel implements ActionListener {
    ...
    private void newPiece()  {
        ...
        if (!tryMove(curPiece, curX, curY)) {
            ...
            timer.stop();
            isStarted = false;
            menuPrincipal=new MenuTetris();
            menuPrincipal.setScore(String.valueOf(numLinesRemoved*100));
    
            statusbar.setText("game over, [Enter] Jugar Nuevamente - [Q] Salir");
    ...
    class TAdapter extends KeyAdapter {
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if (keycode==KeyEvent.VK_ENTER){
                String[] args={"hi"};
                Main.isDefaultLookAndFeelDecorated();
